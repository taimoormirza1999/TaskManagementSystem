        ...
        <nav class="navbar navbar-expand dashboard-top-header bg-white">
            <div class="container-fluid">
                ...
                <div class="dashboard-nav-brand">
                    <a class="dashboard-logo" href="/">Task Management System</a>
                </div>
                <!-- ============================================================== -->
                <!-- end brand logo -->
                <!-- ============================================================== -->
                    ...
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="error-section">
                            ...
                            <div class="error-section-content">
                                <h1 class="display-7">403 Page Forbidden</h1>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-dark text-center">
                            Copyright © 2023 Task Management System. All rights reserved. Dashboard by <a href="https://taimoor-hamza-fullstack-developer.vercel.app/">Taimoor Hamza</a>.
                        </div>
                    </div>
                </div>
            </div>
